...
export default function AboutUs() {
  return (
    <section id="about" className="relative py-80 px-4 text-black z-10 bg-[#F5F5DC] overflow-hidden">
      ...
      <div className="absolute font-michroma  top-12 left-0 w-full text-black z-0 space-y-4">
...
<VelocityScroller text="OVERSOCKS" direction={-1} velocity={80} textSize="text-[50px] md:text-[80px]" />
      ...
      <div className="space-y-20 relative z-10 max-w-5xl mx-auto text-center">
        <ScrollFloat containerClassName="text-5xl text-red-500 md:text-6xl font-anton font-extrabold uppercase">
          About OVERSOCKS
        </ScrollFloat>
        ...
        <div className="grid md:grid-cols-2 gap-12 pt-10">
          {[{
            ...
            <div key={title} className="space-y-6 group">
              <ScrollFloat containerClassName="text-4xl md:text-5xl font-anton uppercase  text-black group-hover:text-red-500 transition-all">
                {title}
              </ScrollFloat>
