...
export default function CategorySection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-screen flex overflow-hidden">
      {/* MEN */}
      <div className="category-tile w-1/3 h-full relative group overflow-hidden cursor-pointer">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
          <h2 className="text-3xl md:text-4xl font-michroma uppercase mb-4">Shop Mens</h2>
      ...
      <div className="category-tile w-1/3 h-full relative group overflow-hidden cursor-pointer">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-30 transition duration-300"></div>
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
          <h2 className="text-3xl md:text-4xl font-michroma uppercase mb-4">Shop Womens</h2>
          <button className="px-6 py-2 bg-white text-black hover:bg-black hover:text-white transition uppercase tracking-wide">
            Explore
          </button>
        </div>
      ...
      <div className="category-tile w-1/3 h-full relative group overflow-hidden cursor-pointer">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-30 transition duration-300"></div>
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
          <h2 className="text-3xl md:text-4xl font-michroma uppercase mb-4">Shop Kids</h2>
          <button className="px-6 py-2 bg-white text-black hover:bg-black hover:text-white transition uppercase tracking-wide">
            Explore
          </button>
        </div>
